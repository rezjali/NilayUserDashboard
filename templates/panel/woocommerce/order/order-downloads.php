...
<section id="wpap-wc-order-downloads" class="wpap-wc-downloads">
    ...
    foreach ($downloads as $downloadable_product) {
        $products[$downloadable_product['product_id']][] = $downloadable_product;
    }
    ?>
