...
<div id="wpap-wc-edit-address">
    ...
    <?php else : ?>
        <div class="wpap-form-wrap">
            <form class="wpap-address-form" method="post">
                <header>
                    <h2>
                ...
                <div class="wpap-address-fields">
                    <?php do_action("woocommerce_before_edit_address_form_{$load_address}"); ?>

                    <?php
                    foreach ($address as $key => $field) {
                        $field['class'] = 'wpap-field-wrap';
                        $field['label_class'] = 'wpap-field-label';
