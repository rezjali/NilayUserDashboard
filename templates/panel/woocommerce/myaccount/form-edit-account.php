...
<div class="wpap-form-wrap">
    <form class="woocommerce-EditAccountForm edit-account" action=""
        ...
        <header>
            <h2><?php esc_html_e('ویرایش حساب', 'arvand-panel'); ?></h2>
        </header>
        ...
        <div class="wpap-fields">
            <div class="wpap-field-wrap">
                <label class="wpap-field-label" for="account_first_name">
            ...
            <div class="wpap-field-wrap">
                <label class="wpap-field-label" for="account_last_name">
            ...
            <div class="wpap-field-wrap">
                <label class="wpap-field-label" for="account_display_name">
            ...
            <div class="wpap-field-wrap">
                <label class="wpap-field-label" for="account_email">
            ...
            <fieldset>
                ...
                <div class="wpap-field-wrap">
                    <label class="wpap-field-label" for="password_current">
                ...
                <div class="wpap-field-wrap">
                    <label class="wpap-field-label" for="password_1">
                ...
                <div class="wpap-field-wrap">
                    <label class="wpap-field-label" for="password_2">
            ...
            <footer>
                ...
                <button type="submit" class="wpap-btn-1" name="save_account_details"
