...
<form id="wpap-modirpayamak" class="wpap-form wpap-sms-settings-form" method="post"
      style="<?php echo $sms['provider'] === 'modirpayamak' ? 'display: block' : ''; ?>">
    <input type="hidden" name="sms_nonce" value="<?php echo wp_create_nonce('sms_nonce'); ?>"/>
    <input type="hidden" name="form" value="wpap_modirpayamak"/>
    <input type="hidden" name="provider_name" value="modirpayamak"/>
    ...
    <div class="wpap-field-wrap">
        ...
        <div>
            ...
            <p class="description"><?php esc_html_e('جهت ارسال کد اعتبارسنجی ورود و ثبت نام. طبق پترنی باشد که در پنل مدیر پیامک تعریف کرده اید.', 'arvand-panel'); ?></p>
        </div>
    </div>

    <div class="wpap-field-wrap">
        <label><?php _e('مثال متن پیامک پترن', 'arvand-panel'); ?></label>

        <div>
            <input type="text" value="<?php esc_html_e('تشکر از عضویت در اروند وردپرس، کد شما: %code%', 'arvand-panel'); ?>"
                   readonly>
            <p class="description"><?php esc_html_e('جهت ارسال کد اعتبارسنجی ورود و ثبت نام. در قسمت "ارسال براساس پترن" پنل مدیر پیامک، قالب پترن خود را بسازید و از متغیر زیر استفاده کنید.', 'arvand-panel'); ?></p>
