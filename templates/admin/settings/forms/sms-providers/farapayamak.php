...
<form id="wpap-farapayamak" class="wpap-form wpap-sms-settings-form" method="post"
      style="<?php echo $sms['provider'] === 'farapayamak' ? 'display: block' : ''; ?>">
    <input type="hidden" name="sms_nonce" value="<?php echo wp_create_nonce('sms_nonce'); ?>"/>
    <input type="hidden" name="form" value="wpap_farapayamak"/>
    <input type="hidden" name="provider_name" value="farapayamak"/>
    ...
    <div class="wpap-field-wrap">
        ...
        <input type="password" name="password" value="<?php esc_attr($opt['password']); ?>"/>
    </div>
    ...
    <div class="wpap-field-wrap">
        ...
        <div>
            ...
            <p class="description"><?php _e('شماره خط خدماتی (برای پیامک ساده)', 'arvand-panel'); ?></p>
        </div>
    </div>
    ...
    <div class="wpap-field-wrap">
        ...
        <div>
            ...
            <p class="description"><?php esc_html_e('جهت ارسال کد اعتبارسنجی ورود و ثبت نام. طبق متن الگویی باشد که در پنل فراپیامک تعریف کرده اید.', 'arvand-panel'); ?></p>
        </div>
    </div>
    ...
    <div class="wpap-field-wrap">
        ...
        <div>
            <input type="text"
                   ...
                   readonly>
            <p class="description"><?php esc_html_e('جهت ارسال کد اعتبارسنجی ورود و ثبت نام. در قسمت "ابزار ویژه" سپس "وب سرویس خدماتی" در پنل فراپیامک، متن الگوی خود را بسازید و از متغیر زیر استفاده کنید.', 'arvand-panel'); ?></p>
